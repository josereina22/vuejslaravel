    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if(!this.nombre) this.errorMostrarMsjPersona.push("En nombre de la persona no puede estar vacio");
                if(!this.usuario) this.errorMostrarMsjPersona.push("En nombre de usuario no puede estar vacio");
